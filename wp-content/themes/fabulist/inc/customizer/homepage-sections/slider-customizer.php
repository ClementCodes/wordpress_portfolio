...
// slider menu enable setting and control.
$wp_customize->add_setting( 'fabulist_theme_options[slider_entire_site]', array(
	'default'           => fabulist_theme_option('slider_entire_site'),
	'sanitize_callback' => 'fabulist_sanitize_switch',
) );

$wp_customize->add_control( new Fabulist_Switch_Control( $wp_customize, 'fabulist_theme_options[slider_entire_site]', array(
	'label'             => esc_html__( 'Enable Entire Site', 'fabulist' ),
	'section'           => 'fabulist_slider_section',
	'on_off_label' 		=> fabulist_show_options(),
) ) );

// slider trasnition control and setting
$wp_customize->add_setting( 'fabulist_theme_options[slider_color]', array(
	'default'          	=> fabulist_theme_option('slider_color'),
	'sanitize_callback' => 'fabulist_sanitize_select',
) );

$wp_customize->add_control( 'fabulist_theme_options[slider_color]', array(
	'label'             => esc_html__( 'Content Background', 'fabulist' ),
	'section'           => 'fabulist_slider_section',
	'type'				=> 'radio',
	'choices'			=> array( 
		'light' 	=> esc_html__( 'Light', 'fabulist' ),
		'dark' 		=> esc_html__( 'Dark', 'fabulist' ),
	),
) );

...
if ( ! function_exists( 'fabulist_add_slider_section' ) ) :
    ...
    */
    function fabulist_add_slider_section() {
        ...
        $slider_enable = apply_filters( 'fabulist_section_status', 'enable_slider', 'slider_entire_site' );
...
if ( ! function_exists( 'fabulist_render_slider_section' ) ) :
   ...
   */
   function fabulist_render_slider_section( $content_details = array() ) {
        ...
        $slider_color = fabulist_theme_option( 'slider_color', 'light' );
        ?>
    	<div id="custom-header">
            <div class="section-content banner-slider column-1 <?php echo esc_attr( $slider_color ); ?>" data-slick='{"slidesToShow": <?php echo apply_filters( 'fabulist_slider_slidestoshow_filter', 1 ); ?>, "slidesToScroll": 1, "infinite": true, "speed": 1200, "dots": false, "arrows": true, "autoplay": true, "fade": <?php echo apply_filters( 'fabulist_slider_fade_filter', 'true' ); ?>, "draggable": true }'>
